 ...
 * @return char*
 */
char *FileSystem::file_to_buffer(char *filePath) {
    char *buffer;
    FILE *fp;
    try {
        fp = fopen(filePath, "r");
...
char *FileSystem::getFilePath(char *socketRequest) {
    ...
    getcwd(tempfilePath, 500);
    char *filePath;
    filePath = (char *)malloc(strlen(tempfilePath) + strlen(file) + 1);
